  ...
  return (
    <div>
      ...
      <section id="examples" className="mx-auto max-w-6xl px-4 py-12 md:py-16">
        <SectionTitle kicker="EXAMPLES" title="Preview motion" desc="Temporary previews from reference sites." />
        ...
        <div className="mt-4 text-xs text-black/45">
          Note: these videos are linked from third-party sources for preview only.
        </div>
      </section>
      ...
      <section id="features" className="mx-auto max-w-6xl px-4 py-12 md:py-16">
        ...
        <div className="grid gap-4 md:grid-cols-3">
          {[{
            ...
            t: "Fast iteration",
            d: "Upload → prompt → generate → compare (backend next).",
          }, {
            t: "Consistent identity",
            d: "Preserve character look while transferring motion.",
          }].map((c) => (
            <div key={c.t} className="rounded-3xl border border-black/10 bg-white p-5">
      ...
      <section className="mx-auto max-w-6xl px-4 py-12 md:py-16">
        ...
        <div className="grid gap-4 md:grid-cols-3">
          {[
            ...
            <div key={s.n} className="rounded-3xl border border-black/10 bg-white p-5">
      ...
      <section className="mx-auto max-w-6xl px-4 pb-16">
        <div className="rounded-3xl border border-black/10 bg-white p-8 shadow-[0_10px_40px_rgba(0,0,0,0.06)]">
          ...
          <div className="mt-5">
            <Link href="/login" className="inline-flex rounded-full bg-[#ff3333] px-5 py-2.5 text-sm font-medium text-white hover:bg-[#ff1f1f]">
              Login
            </Link>
          </div>
        </div>
